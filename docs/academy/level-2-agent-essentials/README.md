...
| 4 | [Agent Workflows](04-agent-workflows.md) | `WorkflowEngine` (shipped), step types |
| 5 | [Agent Memory](05-agent-memory.md) | Short/Long/Episodic/Project/Residual memory tiers + decision/provenance records (ADR-015) |
| 6 | [Agent Evaluation](06-agent-evaluation.md) | `EvalRunner` + `BaselineComparator` (shipped), `EpisodeLearner` (shipped), 4 metrics |
| 7 | [Multi-Step Reasoning](07-multi-step-reasoning.md) | `ReActLoop`, `ChainOfThought` |
| 8 | [Multi-Agent Systems](08-multi-agent-systems.md) | `WorkflowEngine` (shipped), `ParallelStep` (planned), ADR-005 |
