...
import type { LLMRequest, LLMResponse, LLMChunk, LLMConfig, ToolCall } from '../types.js'

function parseToolCall(tc: OpenAI.Chat.ChatCompletionMessageToolCall): ToolCall {
  if (tc.type === 'function') {
    return {
      id: tc.id,
